...
typedef int(*aout_sample_seeker)(void * samp_data, int frames, int whence);
typedef int(*aout_sample_teller)(void * samp_data);
typedef int(*aout_sample_sizer) (void * samp_data);
