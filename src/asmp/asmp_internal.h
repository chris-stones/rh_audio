...
typedef int(*aud_sample_seeker)(aud_sample_handle p, int frames, int whence);
typedef int(*aud_sample_teller)(aud_sample_handle p);
...
struct aud_sample_type {
  ...
  aud_sample_seeker seeker;
  aud_sample_teller teller;
